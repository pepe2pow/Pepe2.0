...
void BitcoinGUI::createActions()
{
    ...
    sendCoinsAction->setStatusTip(tr("Send coins to an PEPE2 address"));
    ...
    receiveCoinsAction->setStatusTip(tr("Request payments (generates QR codes and PEPE2: URIs)"));
    ...
    signMessageAction->setStatusTip(tr("Sign messages with your PEPE2 addresses to prove you own them"));
    verifyMessageAction = new QAction(tr("&Verify message..."), this);
    verifyMessageAction->setStatusTip(tr("Verify messages to ensure they were signed with specified PEPE2 addresses"));
    ...
    openAction->setStatusTip(tr("Open an PEPE2: URI"));
    ...
    showHelpMessageAction->setStatusTip(tr("Show the %1 help message to get a list with possible PEPE2 command-line options").arg(PACKAGE_NAME));
...
void BitcoinGUI::updateNetworkState()
{
    ...
    if (m_node.getNetworkActive()) {
        tooltip = tr("%n active connection(s) to PEPE2 network", "", count) + QString(".<br>") + tr("Click to disable network activity.");
    } else {
