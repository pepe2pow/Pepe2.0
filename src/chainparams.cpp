...
public:
    CMainParams() {
        ...
        const uint256 GENESIS_HASH = uint256S("00000014d25275339bd9474df27effab3fad2cb92f195c46cf2775a3102081af");
        ...
        genesis = CreateGenesisBlock(1688385600, 1275054, 0x1e0fffff, 1, 50 * COIN);
//        MineGenesis(genesis,consensus.powLimit,false);
        ...
        vSeeds = {};
        vSeeds.emplace_back("15.235.140.126");
        vSeeds.emplace_back("146.59.80.38");
...
public:
    CTestNetParams() {
        ...
        const uint256 GENESIS_HASH = uint256S("03aa32f13836f0e18960af85d891d70a6baaf64c40bfe59dacbf6247d18ed415");
        consensus.nSubsidyHalvingInterval = 2102400;
        consensus.BIP16Exception = GENESIS_HASH;
        consensus.BIP34Height = 1;
        consensus.BIP34Hash = GENESIS_HASH;
        ...
        genesis = CreateGenesisBlock(1688198900, 0, 0x207fffff, 1, 50 * COIN);
//        MineGenesis(genesis,consensus.powLimit,false);
        consensus.hashGenesisBlock = genesis.GetHash();
...
public:
    explicit CRegTestParams(const ArgsManager& args) {
        ...
        genesis = CreateGenesisBlock(1688199000, 0, 0x207fffff, 1, 50 * COIN);
//        MineGenesis(genesis,consensus.powLimit,false);
        consensus.hashGenesisBlock = genesis.GetHash();
        assert(consensus.hashGenesisBlock == uint256S("27ec05743d410e67ca61cab661c09f4bce7d63769704f67a24a219550510abd8"));
        assert(genesis.hashMerkleRoot == uint256S("c4a47847658174dff39f23e69c2246e7e611752884ceb600694a8619adbbfef5"));
        ...
        checkpointData = {
            {
                {0, uint256S("27ec05743d410e67ca61cab661c09f4bce7d63769704f67a24a219550510abd8")},
            }
        };
