...
const char * const BITCOIN_CONF_FILENAME = "pepe2.conf";
...
{
    // Windows < Vista: C:\Documents and Settings\Username\Application Data\PEPE2
    // Windows >= Vista: C:\Users\Username\AppData\Roaming\pepe2
    // Mac: ~/Library/Application Support/pepe2
    // Unix: ~/.pepe2
#ifdef WIN32
    // Windows
    return GetSpecialFolderPath(CSIDL_APPDATA) / "pepe2";
#else
    fs::path pathRet;
...
#ifdef MAC_OSX
    // Mac
    return pathRet / "Library/Application Support/pepe2";
#else
    // Unix
    return pathRet / ".pepe2";
#endif
#endif
}
