...
class AvoidReuseTest(BitcoinTestFramework):
    ...
    def test_fund_send_fund_senddirty(self):
        '''
        Test the same as test_fund_send_fund_send, except send the 10 PEPE2 with
        the avoid_reuse flag set to false. This means the 10 PEPE2 send should succeed,
    ...
    def test_fund_send_fund_send(self, second_addr_type):
        ...
        [0] sends 10 PEPE2 to A.
        [1] spends 5 PEPE2 from A. (leaving roughly 5 PEPE2 useable)
        [0] sends 10 PEPE2 to A again.
        [1] tries to spend 10 PEPE2 (fails; dirty).
        [1] tries to spend 4 PEPE2 (succeeds; change address sufficient)
        '''
