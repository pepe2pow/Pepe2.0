...
The data directory is the default location where the PEPE2 Core files are stored.
...
---------|--------------------
Linux    | `$HOME/.PEPE2/`
macOS    | `$HOME/Library/Application Support/PEPE2/`
Windows  | `%APPDATA%\PEPE2\` <sup>[\[1\]](#note1)</sup>
