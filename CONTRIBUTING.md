Contributing to PEPE2 Core
============================

The PEPE2 Core is based on the Bitcoin Core. The project operates an open
...
Whether a pull request is merged into PEPE2 Core rests with the project merge
...
Patches that change PEPE2 consensus rules are considerably more involved than
...
Where a patch set proposes to change the PEPE2 consensus, it must have been
...
The project leader is the release manager for each PEPE2 Core release.
